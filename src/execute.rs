...
mod tests {
    ...
    fn test_execute_set_denom_restrictions() {
        ...
        let info = message_info(&MockApi::default().addr_make("executor"), &[]);
    ...
    fn test_query_denom_restrictions() {
        ...
        let returned_channels: Vec<String> = from_json(res).unwrap();
    ...
    fn test_permissions_enforced() {
        ...
        let info = message_info(&MockApi::default().addr_make("unauthorized_user"), &[]);
